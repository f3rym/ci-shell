...
// Сетка ленты колонок (Фаза 13, NAV-01…NAV-04): единая сетка на все колонки,
// заменяющая прежние минимумы и доли отдельных экранов (TreePanelMin,
// RunsPanelMin, TreeSharePercent ниже и StepsPanelMin, EnvPanelMin,
// StepsSharePercent выше) — они существуют до плана 13-02, где отрисовка
// переезжает на ленту, и там же уходят: держать две сетки одновременно
// дольше одного плана нельзя.
//
